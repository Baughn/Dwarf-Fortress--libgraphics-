enum InterfaceKey
{
	...
	INTERFACEKEY_WORLD_PARAM_TITLE,
	...
	INTERFACEKEY_BUILDJOB_STOCKPILE_MASTER,
...
class interfacest
{
	...
	public:
		unsigned char c;
		bool shift,caps,ctrl,alt,upper;
