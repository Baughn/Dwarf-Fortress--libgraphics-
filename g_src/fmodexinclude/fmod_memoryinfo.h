...
typedef enum
{
    ...
    FMOD_MEMTYPE_OUTPUTMODULE          = 4,      /* Output module object and internals */
    ...
    FMOD_MEMTYPE_SAMPLE                = 11,     /* Sample objects */
...
#define FMOD_MEMBITS_OUTPUTMODULE                (1 << FMOD_MEMTYPE_OUTPUTMODULE)        /* Output module object and internals */
...
#define FMOD_MEMBITS_SAMPLE                      (1 << FMOD_MEMTYPE_SAMPLE)              /* Sample objects */
